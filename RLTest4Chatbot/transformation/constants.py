from RLTest4Chatbot.constants import FRAMEWORK_PATH
...
"""
Valid rate for each transformation (to be fineuned later)
"""

WORD_INSERT_VALID = 0.8
WORD_DROP_VALID = 0.8
WORD_REPLACE_VALID = 0.8
CHAR_INSERT_VALID = 0.8
CHAR_DROP_VALID = 0.8
CHAR_REPLACE_VALID = 0.8
