"""
Source https://github.com/cycraig/MP-DQN/blob/master/agents/pdqn.py
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--episodes', default=2000, help='Number of epsiodes.', type=int) #20000
    ...
    act, act_params, all_params = agent.act(state)
    print(act)
    print(act_params, "act params")
    print(all_params, "all params")
